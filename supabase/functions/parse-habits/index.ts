    ...
    const response = await fetch("https://api.openai.com/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `You are a health habit parser for the "Future You" educational health visualization app. Given a user's description of their lifestyle habits, extract structured data and provide evidence-based health insights.
${demographicContext}
